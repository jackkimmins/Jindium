...
";
        ...
        public static string NewJindiumConfigFile()
        {
            string[] lines = new string[]
            {
                ...
                "site-version=1",
                "site-name=" + General.CleanStringForTitle("A Server Instance"),
                "site-description=Just another Jindium Server",
                "site-author=Jindium",
                "php-path=php"
            };
        ...
        private static string ReturnStaticError(string code, string siteName)
        {
        ...
        private static string ReturnStaticWelcome(string siteName)
        {
